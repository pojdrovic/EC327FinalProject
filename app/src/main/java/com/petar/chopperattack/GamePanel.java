...
import android.media.MediaPlayer; // What you need to have to be able to play a longer file
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    //Variables for sound
    private SoundPool sounds; // used like a holder
    private int boom; // Sound of the explosion - holds info where you load and play the sound
    private int chopper = 1; // Number of 'Choppers'

    private SoundPool chopper1;
    private int flap;


    //increase to slow down difficulty progression, decrease to speed up difficulty progression
    private int progressDenom = 50;
    ...
    //MediaPlayer bkgrdmsc; // Variable that holds background music infor music
    ...
    public GamePanel(Context context)
    {
        ...
        //bkgrdmsc = MediaPlayer.create(context, R.raw.background_music);
        //bkgrdmsc.setLooping(true);
        //bkgrdmsc.start();


        sounds = new SoundPool(5,AudioManager.STREAM_MUSIC, 0);
        boom = sounds.load(context, R.raw.boom, 1);

        chopper1 = new SoundPool(5,AudioManager.STREAM_MUSIC, 0);
        flap = chopper1.load(context, R.raw.choppersound,1 );
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        //bkgrdmsc = MediaPlayer.create(GamePanel.this, R.raw.background_music);
        //bkgrdmsc.setLooping(true);
        //bkgrdmsc.start();

        //MediaPlayer mPlayer = MediaPlayer.create(GamePanel.this, R.raw.background_music);
        //mPlayer.start();
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        if(event.getAction()==MotionEvent.ACTION_DOWN){
            if(!player.getPlaying() && newGameCreated && reset)
            {
                ...
                player.setUp(true);
                chopper1.play(flap, 50.0f, 50.0f, 0 ,0, 1f);
                return true;
    ...
    public boolean collision(GameObject a, GameObject b)
    {
        ...
        {
            sounds.play(boom, 1.0f, 1.0f, 0 ,0, 1.5f);
            return true;
    ...
    public void drawText(Canvas canvas)
    {
        ...
        if(!player.getPlaying()&&newGameCreated&&reset)
        {
            ...
            canvas.drawText("Touch Anywhere to Start!", WIDTH/2-50, HEIGHT/2, paint1);

            paint1.setTextSize(20);
            canvas.drawText("Touch for Throttle!", WIDTH/2-50, HEIGHT/2 + 20, paint1);
